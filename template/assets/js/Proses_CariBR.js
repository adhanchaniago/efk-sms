...
$('#multibranch1').show();
     ...
     //fungsi rupiah tax code
      if (response.txt_taxcode.length > 0) {
   ...
   selisih = Math.ceil(timeDiff / (1000 * 3600 * 24)); 
    ...
    return selisih;
      ...
      document.getElementById("txt_slaprmb").value = convertdatetampil(response.txt_appdate, response.txt_prdate);
        document.getElementById("txt_slapomb").value = convertdatetampil(response.txt_podate, response.txt_appdate);
    document.getElementById("txt_slaerdatemb").value = convertdatetampil(response.txt_erdate, response.txt_podate);
     document.getElementById("txt_slakirimmb").value = convertdatetampil(response.txt_ti, response.txt_erdate);
      document.getElementById("txt_slacabangmb").value = convertdatetampil(response.txt_ti, response.txt_prdate);
      document.getElementById("txt_acctmb").value = convertdatetampil(response.txt_accdate, response.txt_tpc);
       document.getElementById("txt_slafinmb").value = convertdatetampil(response.txt_tglcair, response.txt_accdate);
       document.getElementById("txt_slahqmb").value = convertdatetampil(response.txt_tglcair, response.txt_ti);
...
$("#txt_checker").change(function() {
    ...
    //$('#txt_validator1').val(txt);
     ...
     $.ajax({
        ...
        //url:'http://localhost:8080/er-tracking/Home/getChecker',
